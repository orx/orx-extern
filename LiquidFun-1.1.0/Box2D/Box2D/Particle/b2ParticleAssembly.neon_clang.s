...
//@
        ...
        .balign   4
        .thumb
        .globl   _CalculateTags_Simd
        .thumb_func _CalculateTags_Simd
...
L_CalculateTags_Return:
        ...
        .balign   4
        .thumb
        .thumb_func FindContacts_PostProcess
//        @
...
CONST_IS_CLOSE_TABLE_INDICES:
        ...
        .balign   4
        .thumb
        .globl   _FindContactsFromChecks_Simd
        .thumb_func _FindContactsFromChecks_Simd
_FindContactsFromChecks_Simd:
//        @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
//        @
