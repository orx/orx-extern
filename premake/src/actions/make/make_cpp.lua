...
--
	...
	function premake.make_cpp(prj)
		...
		if os.is("MacOSX") and prj.kind == "WindowedApp" then
			_p('all: $(TARGETDIR) $(OBJDIR) $(TARGET) $(dir $(TARGETDIR))PkgInfo $(dir $(TARGETDIR))Info.plist')
		else
			_p('all: $(TARGETDIR) $(OBJDIR) $(TARGET)')
		end
		_p('\t@:')
		_p('')

		-- target build rule
		_p('$(TARGET): prebuild $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES) prelink')
...
--
	...
	function cpp.flags(cfg, cc)
		...
		_p('  ALL_CFLAGS    += $(CFLAGS) $(ALL_CPPFLAGS)%s', make.list(table.join(cc.getcflags(cfg), cc.getcstdflags(cfg), cfg.buildoptions)))
		_p('  ALL_CXXFLAGS  += $(CXXFLAGS) $(CFLAGS) $(ALL_CPPFLAGS)%s', make.list(table.join(cc.getcflags(cfg), cc.getcxxflags(cfg), cfg.buildoptions)))
...
--
	...
	function cpp.linker(cfg, cc)
		...
		if cfg.kind == "StaticLib" then
			...
			if cfg.platform == "Web" then
				_p('  LINKCMD    = $(%s) -o $(TARGET) $(OBJECTS) $(ALL_LDFLAGS) $(LIBS)', tool)
			else
