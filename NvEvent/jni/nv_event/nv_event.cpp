...
public:
    MethodRef(const char* name, const char* signature) :
      m_name(name), m_signature(signature), m_index(NULL) { }
...
static MethodRef s_loadFile("loadFile", "(Ljava/lang/String;)Lcom/nvidia/devtech/NvEventQueueActivity$RawData;");
static MethodRef s_loadTexture("loadTexture", "(Ljava/lang/String;)Lcom/nvidia/devtech/NvEventQueueActivity$RawTexture;");
