...
static __inline __int32 lrint(double _d)
{
    return ((long)floor(_d + (_d > 0.0) ? 0.5 : -0.5));
}

static __inline __int32 lrintf(float _f)
{
    return ((long)floorf(_f + (_f > 0.0f) ? 0.5f : -0.5f));
}
